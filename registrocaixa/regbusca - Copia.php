            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
			        ...
			        <form id="formbusca" method="POST" action="regbusca.php">					
								<div class="col-md-12" >
									<div class="form-group">             
									  <label>Escolha o que quer buscar</label>
									  <ul class="nav nav-tabs">
										  <li class="nav-item">
										    <a class="nav-link active" id="custom-tabs-cliente-tab" data-toggle="pill" href="#custom-tabs-cliente" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">&nbsp;Cliente</a>
										  </li>
										  <li class="nav-item">
										    <a class="nav-link" id="custom-tabs-fornecedor-tab" data-toggle="pill" href="#custom-tabs-fornecedor" aria-controls="custom-tabs-two-profile" aria-selected="false">&nbsp;Fornecedor</a>
										  </li>
										  <li class="nav-item">
										    <a class="nav-link" id="custom-tabs-data-tab" data-toggle="pill" href="#custom-tabs-data" aria-controls="custom-tabs-two-profile" aria-selected="false">&nbsp;Data</a>
										  </li>
										</ul>
										<div class="tab-content" id="custom-tabs-two-tabContent">
											<div class="tab-pane fade active show" id="custom-tabs-cliente" role="tabpanel" aria-labelledby="custom-tabs-two-painel-tab">
										   	<div class="input-group text-left">				  
											 	  <input id="texto" name="texto" type="text" class="form-control input" placeholder="Insira o texto para busca (cliente)"id="texto" required title="Digite uma texto para a busca">
											 	  <span class="input-group-btn">
											      <button type="submit" class="btn btn-primary" type="submit" id="btnbuscar"><i class='fa fa-search'></i>&nbsp;Buscar</button></span>
												</div>
											</div>
											<div class="tab-pane fade" id="custom-tabs-fornecedor" role="tabpanel" aria-labelledby="custom-tabs-two-painel-tab">
										   	<div class="input-group text-left">				  
											...
											<div class="tab-pane fade" id="custom-tabs-data" role="tabpanel" aria-labelledby="custom-tabs-two-painel-tab">
										   	<div class="input-group text-left">				  
										  ...
										  <table class="table table-hover table-checkable full-width" style="overflow:auto;">
											...
											<tbody>
											  ...
											  if(isset($_POST['texto'])){
												 ...
												 $sql = "select * from tbregistro where cliente like '%".$_POST['texto']."%'";
