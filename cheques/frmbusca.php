  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Consultar Cheques</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
              ...
              <div class="card-body">
                ...
                <form name="f1" action="frmbusca.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <a href="tela.php" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i>&nbsp;Voltar</a>
                  </div>
                  <!--Botão de Buscar-->
                  <div class="form-group">
